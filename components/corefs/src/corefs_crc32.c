/**
 * CRC32 Implementation for CoreFS
...
/**
 * Calculate CRC32 incrementally (for large data)
 * 
 * @param crc Previous CRC value (0xFFFFFFFF for first chunk)
 ...
 * 
 * @param crc CRC value from crc32_update()
